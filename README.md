...
```bash
// 拉取
docker pull lhzzs/dailyhot-api:1.0.5
// 运行
docker run -p 6688:6688 -d lhzzs/dailyhot-api:1.0.5
```
...
```http
GET https://api-hot.lhzzs.top/bilibili/
```
...
```http
GET https://api-hot.lhzzs.top/bilibili/new
```
